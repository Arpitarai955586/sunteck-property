        ...
        <div className="grid grid-cols-1 lg:grid-cols-[3fr_2fr] gap-8 items-center">
          ...
          <div className="reveal-left">
            ...
            >
              <Image
                ...
                alt="Sunteck OneWorld Location Advantage Map"
                fill
              ...
              <div className="absolute inset-0 bg-navy/0 group-hover:bg-navy/20 transition-all duration-300 flex items-center justify-center">
                <span className="opacity-0 group-hover:opacity-100 text-white text-4xl transition-opacity duration-300">
                  🔍
                </span>
              </div>
            </div>
          ...
          <div className="reveal-right">
            ...
            <h3 className="font-playfair text-2xl md:text-3xl font-bold text-navy mb-6">
              Strategic Location,{" "}
              <span className="text-gold">Unmatched Access</span>
            </h3>
            ...
            <div className="space-y-2">
              {locationPoints.map((point, i) => (
                <div
                  key={i}
                  className="loc-item reveal"
                  style={{ transitionDelay: `${i * 80}ms` }}
                >
                  <div className="shrink-0 w-8 h-8 rounded-full bg-gold/15 flex items-center justify-center text-gold text-sm font-bold">
                    {i < 3 ? "🚉" : "🔗"}
                  </div>
                  <div>
                    {point.time && (
                      <span className="font-bold text-gold text-sm mr-2">
                        {point.time}
                      </span>
                    )}
